...
schema2 = JsonSchema()
strings_analysis_blueprint = Blueprint('string_analysis', __name__, url_prefix='/api/algorithms/string-analysis')
...
# algorithms-1  | Make sure all imports, decorators, functions, etc. needed to set up the blueprint are done before registering it.
